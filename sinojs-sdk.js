!function (windowz, n) {
    ...
    function call(apiName, params, callBack) {
        windowz.sinoJSBridge ? windowz.sinoJSBridge.call(apiName, checkParams(params), function (ret) {
    ...
    function defCall(apiName, callBack) {
        ...
        console.log("sinoJSBridge not found ," + apiName)
    }

    function on(eventName, callBack) {
        windowz.sinoJSBridge ? windowz.sinoJSBridge.on(eventName, function (ret) {
            callBack(ret)
    ...
    function defOn(eventName, callBack) {
        callBack.complete && callBack.complete()
        console.log("sinoJSBridge not found ," + eventName)
    }
    ...
    return open && (windowz.sino = api), api
})